    ...
    <div class="form-box">
        <div class="form-tab">
            <ul class="nav nav-pills nav-fill" role="tablist">
                <li class="nav-item">
                    <a class="nav-link">Register As Supplier</a>
                </li>  
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade show active">
                    ...
                    @endif
                    <form name="registerForm" id="registerForm" method="POST" action="{{ route('supplier.register') }}">
                         @csrf
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="+880xxxxxxxxxx" value="{{ old('phone') }}" required />
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
