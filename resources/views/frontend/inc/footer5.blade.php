            ...
            <div class="row justify-content-center text-center">
                <div class="col-sm-12 col-lg-4">
                    <div class="widget widget-about">
                        <img src="{{ asset('images/company/' . $company->company_logo) }}" alt="Footer Logo" width="105" height="25" class="mx-auto d-block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-12 mt-3">
                                    ...
                                    <figure class="footer-payments">
                                        <img src="{{ asset('frontend/images/payments.png') }}" alt="Payment methods" width="272" height="20" class="mx-auto d-block">
                                    </figure>
                                </div>
                            </div>
                        </div>
