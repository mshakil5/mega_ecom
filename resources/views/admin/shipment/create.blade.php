    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 d-flex justify-content-start align-items-center">
                ...
                <button type="button" class="btn btn-info my-3" id="previousShipmentBtn">
                    Previous Shippings
                </button>
            </div>
        </div>
...
<!-- Previous Shipment -->
<section class="content" id="previousShipmentSection" style="display: none;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Previous Shippings</h3>
                    </div>
                    <div class="card-body">
