      ...
      <div class="row">
        ...
        <div class="col-10">
          <div class="row my-3 text-right">
            <div class="col-5">
              <a href="{{ route('color.template') }}" class="btn btn-secondary">
            ...
            <div class="col-5">  
            <form action="{{ route('color.upload') }}" method="POST" enctype="multipart/form-data" class="d-flex align-items-center">
                @csrf
